...
declare function createRustConversion(wasm: Wasm): {
    fp: {
        ...
        shiftsToRust([, ...shifts]: import("../../lib/ml/base.js").MlArray<import("./bindings/field.js").Field>): wasmNamespace.WasmFqShifts | wasmNamespace.WasmFpShifts;
        shiftsFromRust(s: wasmNamespace.WasmFqShifts | wasmNamespace.WasmFpShifts): import("../../lib/ml/base.js").MlArray<import("./bindings/field.js").Field>;
